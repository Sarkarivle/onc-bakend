...
3. **Tool/Data Selection (Dynamic)**:
    ...
    - **DATE CALCULATION**: Today's date is provided in the [DATE AWARENESS] section. You MUST NOT guess or use manual math. To calculate "days remaining", you MUST use CALL_TOOL: DATE_DIFF({ "date1": "today_date", "date2": "deadline_date" }). Use the format DD/MM/YYYY for dates.
