/**
 * VectorMatcher Module (Formerly EmbeddingIntentMatcher)
 * Responsibility: Hybrid semantic matching.
 */
const IntentExampleRegistry = require('../intentExampleRegistry');
const LangNormalizer = require('../normalizers/langNormalizer');
...
class VectorMatcher {
    ...
    static normalize(text = "") {
        return text
            .replace(/^(.+)$/, LangNormalizer.normalize)
            .toLowerCase()
            .replace(/[?؟!.,"']/g, ' ')
