 ...
 * Additive by design: old keyword rules still live in IntentDetector.
 */
...
class IntentExampleRegistry {
    static getExamples(intent) {
        return INTENT_EXAMPLES[intent] || [];
    }

    static getAllIntents() {
        return Object.keys(INTENT_EXAMPLES);
    }
    ...
    static getMetadata(intent) {
        return INTENT_METADATA[intent] || { domainIntent: 'GENERAL' };
    }
}
