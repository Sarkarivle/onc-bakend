...
class StrongIntentResolver {
    static resolve(text = "", ruleResult = {}) {
        ...
        const hasJobAsk = /(job|jobs|vacancy|vacancies|bharti|naukri|kaam|rojgar|form|apply|ke liye|dikhao|batao|hai kya|chahiye|jankari| kab |kab tak|notification|recruitment|update|updates|details|year|date|opening|listing|in\s+\w+)/.test(q);
