...
AIService.processRequest.mockImplementation(async (input) => {
    ...
    if (state.topic?.includes('JHTET') && q.includes('vacancy')) {
        message = "JHTET 2026 ek yogyata pariksha (eligibility test) hai, direct vacancy nahi hai. Isliye isme vacancy count seedhe taur par lagu nahi hota. Ye ek पात्रता परीक्षा hai, isme सीधी भर्ती नहीं hoti. Direct recruitment nahi hai. Vacancy nahi hai.";
    }
